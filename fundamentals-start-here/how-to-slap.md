...
This area of the string is easiest to get a solid slap sound from, and it will be your "home" when slapping. It's also the point where the strings offer the least resistance to being moved towards the fretboard \(in the area not lying over the fretboard\). Note that we typically don't want to hit the area of the string that lies over the fretboard, but this might happen when you're first starting out.
